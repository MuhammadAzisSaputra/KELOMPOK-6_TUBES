                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row" style="height: 600px;">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <ul class="flex-list">
                                    <li class="foruser li1"><a href="login.html" class="btn btn-primary">Login</a><img
                                        src="asset/gambar/avatarlogin.png"
                                        style="width: 100px; margin-bottom: 150px; margin-top: -25px;"></li>
                                        <li class="foruser li2"><a href="register.html"
                                            class="btn btn-success">Register</a><img src="asset/gambar/avatarregis.png"
                                            style="width: 100px; margin-bottom: 150px; margin-top: -25px;"></li>
                                            <li class="foruser li3"><a href="forgot.html" class="btn btn-danger">Forgot
