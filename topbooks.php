    ...
    <nav class="navbar navbar-expand-lg navbar-light px-5" style="background-color: burlywood;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="index.html" data-toggle="modal" data-target="#logoutModal">Logout</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <div class="main">
    ...
    <center>
      <div class="card-deck mt-lg-3 mb-4 w-100">
        <div class="card" data-aos="flip-left" data-aos-duration="750" data-aos-delay="100"><a href="buku1.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-left" data-aos-duration="750" data-aos-delay="200"><a href="buku2.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-left" data-aos-duration="750" data-aos-delay="300"><a href="buku3.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-left" data-aos-duration="750" data-aos-delay="400"><a href="buku4.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-left" data-aos-duration="750" data-aos-delay="500"><a href="buku5.html"
            style="color: black;">
      ...
      <div class="card-deck mt-lg-3 mb-4 w-100">
        <div class="card" data-aos="flip-right" data-aos-duration="750" data-aos-delay="500"><a href="buku6.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-right" data-aos-duration="750" data-aos-delay="400"><a href="buku7.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-right" data-aos-duration="750" data-aos-delay="300"><a href="buku8.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-right" data-aos-duration="750" data-aos-delay="200"><a href="buku9.html"
            style="color: black;">
        ...
        <div class="card" data-aos="flip-right" data-aos-duration="750" data-aos-delay="100"><a href="buku11.html"
            style="color: black;">
