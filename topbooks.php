  ...
  <div class="main">
      <div class="carousel-inner mt-4 ml-auto mr-auto mb-5 w-100">
        <div class="carousel-item active">
          <img class="d-block" width="93%" height="400px" style="margin-top: 15px; margin-left: 50px; margin-right: 50px; position: relative; border-radius: 25px;" src="asset/gambar/top books.png" alt="First slide">
    ...
    <div class="card-deck mt-lg-3 mb-4 w-100">
        <div class="card"><a href="buku1.php" style="color: black;">
        ...
        <div class="card"><a href="buku2.php" style="color: black;">
        ...
        <div class="card"><a href="buku3.php" style="color: black;">
        ...
        <div class="card"><a href="buku4.php" style="color: black;">
          ...
          <div class="card"><a href="buku5.php" style="color: black;">
      ...
      <div class="card-deck mt-lg-3 mb-4 w-100">
        <div class="card"><a href="buku6.php" style="color: black;">
        ...
        <div class="card"><a href="buku7.php" style="color: black;">
        ...
        <div class="card"><a href="buku8.php" style="color: black;">
        ...
        <div class="card"><a href="buku9.php" style="color: black;">
          ...
          <div class="card"><a href="buku11.php" style="color: black;">
