...
if($_GET['action'] == edit) {
    ...
    $data = $koneksi->query("SELECT * FROM user_library t WHERE t.id  = $id AND t.id_member = $id_member ORDER BY t.nama");

    while ($profil = $data->fetch_array(MYSQLI_ASSOC)) :
        $nama = $profil['nama'];
        $email = $profil['email'];
        $username = $profil['username'];
        $no_telepon = $profil['no_telepon'];
        $alamat = $profil['username'];
...
<div class="container">
    <div class="card" style="background-color: #FFFAE5">
        <div class="card-body">
            <form class="needs-validation" novalidate method="POST" action="updateprofil.php?action=edit&id_member=<?= $id_member ?>">
                <?php else { ?>
                    <form class="needs-validation" novalidate method="POST" action="updateprofil.php?action=tambah">
                    <?php } ?>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" value="<?php $nama ?>" name="nama"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="username" value="" name="username" placeholder="Input username anda" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="alamat" value="" name="username" placeholder="Input alamat anda" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="nomor_telepon" value="" name="nomor_telepon" placeholder="Input no.telepon anda" required>
                                <div class="invalid-feedback">
